...
Graffiti = "/home/rj/lab5_ws/Dataset/Ruggles-Graffiti";

% Load images.
buildingDir = fullfile(Graffiti);
...
M = 2000;      % Maximum number of features
Tiles = [2 2];  % Region of distribution - Number of Rows and Columns
