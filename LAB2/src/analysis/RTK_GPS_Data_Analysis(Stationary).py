...
bag = bagreader('/home/rj/lab2_ws/src/data/stationary_data_field.bag')
...
plt.xlabel('UTM Easting (m)')
plt.ylabel('UTM Northing (m)')
plt.title('Histogram UTM Easting vs UTM Northing')
plt.show()
