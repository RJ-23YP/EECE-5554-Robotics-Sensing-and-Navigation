...
bag = bagreader('/home/rj/lab2_ws/src/data/walking_data_open.bag')
...
plt.title('Histogram UTM Northing vs UTM Easting')
plt.legend()
plt.show()
...
plt.xlabel('UTM Easting (m)')
plt.ylabel('UTM Northing (m)')
plt.title('Walking UTM Northing vs UTM Easting ')
ax.legend()
plt.show()
